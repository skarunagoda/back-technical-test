...
class CheckOrderHandler
{
  ...
  const GEO_FR_MIN_SCORE = 0.6;
  const GEO_FR_LIMIT = 1;
  const GEO_PARAM_ADDRESS = "q";
  const GEO_PARAM_ZIPCODE = "postcode";
  const GEO_PARAM_LIMIT = "limit";
  const HEAVY_WEIGHT = 40000;
  const EXCESSIVE_WEIGHT = 60000;
